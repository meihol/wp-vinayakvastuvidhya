...
class Team extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Team', 'dreamit-elementor-extension' );
    }
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => esc_html__( 'Title Your Name', 'dreamit-elementor-extension' ),
    ...
    protected function render() {
        ...
        <?php }elseif($settings['select_style']=='three'){ ?>
            <div class="team style3">
                ...
                <div class="single-team-share-icon">
                ...
                <img src="<?php echo $settings['image']['url']; ?>" alt="">
                    <div class="team-share"> 
						<div class="team-share-icon"> 
							<span><i aria-hidden="true" class="flaticon flaticon-share"></i></span>     
						</div>
					</div>
                    <ul class="social-icon">
                        <?php foreach (  $settings['list'] as $item ) { ?>
