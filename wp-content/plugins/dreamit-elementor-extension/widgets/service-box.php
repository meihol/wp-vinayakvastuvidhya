...
*/
			...
			$this->add_control(
				...
				[
					...
					'options' => [
						...
						'thirteen' => __( 'Thirteen', 'dreamit-elementor-extension' ),
						'fourteen' => __( 'Fourteen', 'dreamit-elementor-extension' ),
						'fiveteen' => __( 'Fiveteen', 'dreamit-elementor-extension' ),
						'sixteen' => __( 'Sixteen', 'dreamit-elementor-extension' ),
						'seventeen' => __( 'Seventeen', 'dreamit-elementor-extension' )
					],
					'default' => 'one',
		...
		$this->end_controls_tabs();
			...
			$this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .service-box .service-box-icon i' => 'text-align: {{VALUE}};',
					],
				]
			);
			$this->add_responsive_control(
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					...
					'default' => '',
					'selectors' => [
						'{{WRAPPER}} .service-box .content h3' => 'color: {{VALUE}};',
					],
				]
			);
			$this->add_group_control(
				...
				[
					...
					'selector' => '{{WRAPPER}} .service-box .content h3, {{WRAPPER}} .elementor-icon-box-content .elementor-icon-box-title a',
				]
			);
			$this->add_responsive_control(
				'title_margin',
				[
					...
					'size_units' => [ 'px', 'em', '%' ],
					'selectors' => [
						'{{WRAPPER}} .service-box .content h3' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
		$this->end_controls_section();
	...
	protected function render() {
		...
		<?php }
		elseif($settings['select_style']=='two'){ ?>
		...
		<?php }if($settings['select_style']=='four'){ ?>
		...
		<?php }elseif($settings['select_style']=='twelve'){ ?>
			...
			<?php }elseif($settings['select_style']=='thirteen'){ ?>
			
			<div class="service_box style13">
				<div class="icon">
					<?php if($settings['icons_type'] == 'icon' ){ ?>
						<?php \Elementor\Icons_Manager::render_icon( $settings['select_icon'], [ 'aria-hidden' => 'true' ] ); ?>
					<?php }elseif($settings['icons_type'] == 'img'){ ?>
		...
		<?php }elseif($settings['select_style']=='fourteen'){ ?>
			
			<div class="service_box style14">
				<div class="icon">
					<?php if($settings['icons_type'] == 'icon' ){ ?>
						<?php \Elementor\Icons_Manager::render_icon( $settings['select_icon'], [ 'aria-hidden' => 'true' ] ); ?>
					<?php }elseif($settings['icons_type'] == 'img'){ ?>
		...
		<?php }
		elseif($settings['select_style']=='fiveteen'){ ?>
			<div class="service-box style15">
				<div class="icon">
					<?php if($settings['icons_type'] == 'icon' ){ ?>
						<?php \Elementor\Icons_Manager::render_icon( $settings['select_icon'], [ 'aria-hidden' => 'true' ] ); ?>
					<?php }elseif($settings['icons_type'] == 'img'){ ?>
		...
		<?php }
		elseif($settings['select_style']=='sixteen'){ ?>
			<div class="service-box style16">
				<div class="icon">
					<?php if($settings['icons_type'] == 'icon' ){ ?>
						<?php \Elementor\Icons_Manager::render_icon( $settings['select_icon'], [ 'aria-hidden' => 'true' ] ); ?>
					<?php }elseif($settings['icons_type'] == 'img'){ ?>
		...
		<?php }elseif($settings['select_style']=='seventeen'){ ?>
