            ...
            <div class="row">
                <div class="em-nivo-slider-wrapper <?php echo esc_attr($extra_class);?>">
					...
					<?php while ( $post_query->have_posts() ) {
								...
								$em_slide_title  = get_post_meta( get_the_ID(),'_luxury_em_slide_title', true );
								$em_slide_subtitle  = get_post_meta( get_the_ID(),'_luxury_em_slide_subtitle', true );
								$em_slide_textarea  = get_post_meta( get_the_ID(),'_luxury_em_slide_textarea', true );
								$em_slide_btn1  = get_post_meta( get_the_ID(),'_luxury_em_slide_btn1', true );
								$em_slide_btn1utl  = get_post_meta( get_the_ID(),'_luxury_em_slide_btn1utl', true );
								$em_slide_btn2  = get_post_meta( get_the_ID(),'_luxury_em_slide_btn2', true );
								$em_slide_btn2url  = get_post_meta( get_the_ID(),'_luxury_em_slide_btn2url', true );							
								$em_slider_posi  = get_post_meta( get_the_ID(),'_luxury_em_slider_posi', true );
								
								
								$em_aimate_title  = get_post_meta( get_the_ID(),'_luxury_em_aimate_title', true );
								$em_durations_title  = get_post_meta( get_the_ID(),'_luxury_em_durations_title', true );
								$em_dealy_title  = get_post_meta( get_the_ID(),'_luxury_em_dealy_title', true );
								
								
								$em_aimate_image  = get_post_meta( get_the_ID(),'_luxury_em_aimate_image', true );
								$em_durations_image  = get_post_meta( get_the_ID(),'_luxury_em_durations_image', true );
								$em_dealy_image  = get_post_meta( get_the_ID(),'_luxury_em_dealy_image', true );
								
								
								$em_aimate_subtitle  = get_post_meta( get_the_ID(),'_luxury_em_aimate_subtitle', true );
								$em_durations_subtitle  = get_post_meta( get_the_ID(),'_luxury_em_durations_subtitle', true );
								$em_dealy_subtitle  = get_post_meta( get_the_ID(),'_luxury_em_dealy_subtitle', true );

								$em_aimate_content  = get_post_meta( get_the_ID(),'_luxury_em_aimate_content', true );
								$em_durations_content  = get_post_meta( get_the_ID(),'_luxury_em_durations_content', true );
								$em_dealy_content  = get_post_meta( get_the_ID(),'_luxury_em_dealy_content', true );

								$em_aimate_btn  = get_post_meta( get_the_ID(),'_luxury_em_aimate_btn', true );
								$em_durations_btn  = get_post_meta( get_the_ID(),'_luxury_em_durations_btn', true );
								$em_dealy_btn  = get_post_meta( get_the_ID(),'_luxury_em_dealy_btn', true );
								$em_slide_image  = get_post_meta( get_the_ID(),'_luxury_em_slide_img', true );
								$em_slide_video_icon  = get_post_meta( get_the_ID(),'_luxury_youtube_video', true );
